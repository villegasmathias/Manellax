...
export function PopupWidget() {
  ...
  const userName = useWatch({ control, name: 'Enzo' });
  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <DisclosureButton className="fixed z-40 flex items-center justify-center transition duration-300 bg-blue-700 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-blue-800 focus:bg-blue-800 ease">
              ...
              <DisclosurePanel className=" flex flex-col  overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-300 dark:border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                <div className="flex flex-col items-center justify-center h-32 p-5 bg-blue-600">
                  ...
                  <p className="text-white opacity-50">
                    Usualmente respondemos en unas pocas horas
                  </p>
                </div>
