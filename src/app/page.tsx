...
export default function Home() {
  ...
  return (
    <>
      {/* Servicios */}
      <Element name="services" className="pt-20">
        <div id="services">
          <SectionTitle
      ...
      <div className="bg-gray-100 py-20">
        ...
        <SectionTitle title="Misión">
          ...
          vigentes en las distintas industrias, con capacitaciones, entrevistas
          y búsqueda de todos los niveles de experiencia, que prepararán al
          recurso para el ingreso a su futuro profesional, siendo nosotros el
          filtro. Nos comprometemos a hacer crecer los valores y retener
          talentos, ofreciendo asesoría, soluciones innovadoras que garantizan
          el éxito de tu empresa y relaciones laborales, así como en producción,
          seguridad y calidad.
        </SectionTitle>
      </div>
      ...
      <div className=" mt-20 mb-10 py-16 bg-gray-100">
        ...
        <Element name="jobs">
          <div
            ...
            <div className="flex flex-col items-center justify-center h-32 p-5 bg-blue-800">
              ...
              {!isSubmitSuccessful && (
                <form onSubmit={handleSubmit(onSubmit)} noValidate>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 text-gray-600 placeholder-gray-300 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring   ${
                        errors.name
                          ...
                          : 'border-gray-300 focus:border-blue-800 ring-blue-100'
                      }`}
                    />
                    {errors.name && (
                  ...
                  <div className="mb-3">
                    <button
                      type="submit"
                      className="w-full px-3 py-4 text-white bg-blue-700 rounded-md focus:bg-blue-800 focus:outline-none">
                      {isSubmitting ? (
                        <svg
